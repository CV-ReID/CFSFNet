...
parser.add_argument('--model_path', default='./save_model/sysu_v1/model_best.t',help='model save path')#
...
parser.add_argument('--trial', default=1, type=int, help='trial')
...
if args.dataset == 'sysu':##################################################################################################
    ...
    print(f'Rank-1: {cmc[0]:.2%} | Rank-10: {cmc[9]:.2%} | Rank-20: {cmc[19]:.2%} | mAP: {mAP:.2%} | mINP: {mINP:.2%}')
    print (f'All search & multi-Shot:')
    print(f'Rank-1: {cmc_10[0]:.2%} | Rank-10: {cmc_10[9]:.2%} | Rank-20: {cmc_10[19]:.2%} | mAP: {mAP_10:.2%}| mINP: {mINP_10:.2%}')
    print (f'Indoor search & Single-Shot:')
    print(f'Rank-1: {cmc_indoor[0]:.2%} | Rank-10: {cmc_indoor[9]:.2%} | Rank-20: {cmc_indoor[19]:.2%} | mAP: {mAP_indoor:.2%} | mINP: {mINP_indoor:.2%}')
    print (f'Indoor search & multi-Shot:')
    print(f'Rank-1: {cmc_10_indoor[0]:.2%} | Rank-10: {cmc_10_indoor[9]:.2%} | Rank-20: {cmc_10_indoor[19]:.2%} | mAP: {mAP_10_indoor:.2%}| mINP: {mINP_10_indoor:.2%}')
